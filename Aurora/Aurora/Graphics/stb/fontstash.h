...
struct sth_texture
{
	...
	Aurora::Graphics::TexturedVertex newverts[VERT_COUNT];
...
void sth_draw_text(struct sth_stash* stash,
				   int idx, float size,
				   float x, float y, const char* string, float* dx, int measureOnly=0, float retinaScale=1);
