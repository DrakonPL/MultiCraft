...
private :
    ...
    unsigned int                   myPendingHeader;     ///< Data of the current pending packet header, if any
    unsigned int                   myPendingHeaderSize; ///< Size of the current pending packet header, if any
    std::vector<char>        myPendingPacket;     ///< Data of the current pending packet, if any
    int                    myPendingPacketSize; ///< Size of the current pending packet, if any
